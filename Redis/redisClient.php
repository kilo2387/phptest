<?php
/**
 * Created by kilo with IntelliJ IDEA on 2017/7/21 23:30.
 *
 */
...
//$redis = new redis();
//$new = $redis->pconnect('192.168.209.132', 6379);
//var_dump($redis->get('name'));


//$str = 'lhojlsjhfowjl;amsbkghlsa;rwe';
//$in = [];
//for($i=0;$i<10000;$i++) {
//    $n1 = mt_rand(1, 646);
//    $n2 = mt_rand(1, 764);
//    $key = substr($str, $n1, $n2);
//    $key = mt_rand(1, 446464) . $key . mt_rand();
//    $id = sprintf("%u", crc32($key));
//    $m = base_convert(intval(fmod($id, 3)), 10, 3);
//    array_push($in, $m);
//}
//print_r(array_count_values ($in));
//

$redis = new RedisClient($config_redis);
////$obj = $redis->getRedis('name');
////var_dump($obj);
$name = $redis->get('name');
var_dump($name);
////$new = new Redis();
//$new->connect('192.168.209.132', '', '', '', '')